...
public class GestionBD extends SQLiteOpenHelper{
	...
	String sqlCrearTablaInspectores = "create table C_inspector(id_c_inspector INTEGER PRIMARY KEY AUTOINCREMENT, nombre TEXT,ife TEXT , vigente text, no_empleado int not null,vigencia NUMERIC,id_c_direccion int not null,contrasena text,capturo text,fecha numeric)";
	...
	String sqlCrearTablaArticulos= "create table Articulos_fracciones(id_articulo INTEGER PRIMARY KEY AUTOINCREMENT,art Integer,fraccion TEXT,orden Integer)";
	...
	public void onCreate(SQLiteDatabase db) {
		...
		db.execSQL(sqlCrearTablaArticulos);
		...
		Log.i("Gestionar",sqlCrearTablaArticulos);
