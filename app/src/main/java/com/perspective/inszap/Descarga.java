...
public class Descarga extends Activity implements android.content.DialogInterface.OnClickListener, OnClickListener {
	...
	private Button btnDescargarD, btnDescargarF,btnActualizar,btnInfraccion,btnSalir,btnPrueba,btnConfig,btnUpdate,btnConsultarL,btnConsultar,btnReimprimir1,btnConsultarLicenciaC;
	...
	public void insertar() {
		if (!c.search("http://10.10.23.54/infracciones/serverSQL/getC_Direccion.php").trim().equalsIgnoreCase("No se pudo conectar con el servidor")) {
			...
			if (!c.search("http://10.10.23.54/infracciones/serverSQL/getCPeticion.php").trim().equalsIgnoreCase("null")) {
				...
				c.insetarRegistros("http://10.10.23.54/infracciones/serverSQL/get_vs_InspM2.php"/*"http://pgt.no-ip.biz/serverSQL/getC_visitado_manifiesta.php""http://192.168.1.87/serverSQL/getC_Direccion.php"*/, "vs_InspM2");
			}
