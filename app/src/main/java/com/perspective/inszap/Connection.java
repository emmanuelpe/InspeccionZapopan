...
public class Connection {
	...
	public static String inserta(String numero_acta, String numero_citatorio, int infraccion, String tipo_acta, int id_c_direccion, String fechas, String hora_inicio,
			...
			String reincidencia,int tipo_cedula,String etfoliopeticion,String etfolioap,String etfechap,String numero_sellos,String decomiso,String folio_clausura,String fechaclau,String tableta,String version,String url){
    	...
    	try {
			...
			levanta.add(new BasicNameValuePair("tableta",tableta));
			levanta.add(new BasicNameValuePair("version",version));
